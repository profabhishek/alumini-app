    ...
    <table class="email-wrapper" width="580" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
            <td class="header-pad" style="background:linear-gradient(135deg,#1e3a5f 0%,#2563a8 100%);padding:40px 48px;text-align:center;">
                ...
                <h1 style="color:#ffffff;margin:0 0 6px;font-size:24px;font-weight:800;letter-spacing:-0.3px;line-height:1.2;">New Job Opportunity</h1>
        ...
        <tr>
            <td class="email-content" style="padding:36px 48px 20px;">
                ...
                <p style="color:#4b5563;font-size:15px;line-height:1.7;margin:0 0 28px;">A new job opportunity has been posted on the alumni portal. It might be the perfect fit for you or someone you know!</p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        ...
                        <td style="padding:22px 24px 24px;">
                            ...
                            <!-- Title + Company -->
                            <p style="margin:0 0 4px;font-size:18px;font-weight:800;color:#1e3a5f;line-height:1.3;">{{ $job->title }}</p>
                            <p style="margin:0 0 18px;font-size:14px;font-weight:700;color:#e8640c;">{{ $job->company_name }}</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px 0;font-size:14px;color:#1f2937;">{{ $job->location }}</td>
                                </tr>
                                @endif

                                @if($job->job_type || $job->work_mode)
                                <tr>
                                    ...
                                    <td style="padding:5px 0;">
                                        @if($job->job_type)
                                        <span style="display:inline-block;background:#e0edff;color:#1e4d96;border-radius:20px;padding:3px 12px;font-size:12px;font-weight:700;margin-right:6px;">
                                            {{ $job->job_type }}
                                        </span>
                                        @endif
                                        @if($job->work_mode)
                                        <span style="display:inline-block;background:#e8f5e9;color:#2e7d32;border-radius:20px;padding:3px 12px;font-size:12px;font-weight:700;">
                                            {{ $job->work_mode }}
                                        </span>
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:5px 0;font-size:14px;color:#c0440a;font-weight:600;">
                                        {{ \Carbon\Carbon::parse($job->application_deadline)->format('M j, Y') }}
                                    </td>
                                </tr>
                                @endif
        ...
        <tr>
            <td style="padding:20px 48px 36px;text-align:center;">
                <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.7;">
                    You're receiving this because you have <strong style="color:#6b7280;">Job Postings</strong> enabled in your notification settings.<br>
